...
<h3>[ ] Data Portability:</h3>JSON Export/Import features for cross-device migration.
<br><h3>[ ] Dynamic Themes:</h3>System-level Dark Mode integration.
<br><h3>[ ] Categorization:</h3>Grouping habits into Health, Career, and Personal sectors.<br>
